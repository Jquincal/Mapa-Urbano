...
| `reports` | Núcleo del reporte: texto, ubicación, estado, prioridad y seguimiento. | Pertenece a una categoría; tiene imagen, historiales y asignaciones. |
...
| `sessions` | Sesiones revocables del panel, si se persisten en PostgreSQL. | N:1 con `admin_users`. |
...
CREATE TABLE reports (
    ...
    due_at TIMESTAMPTZ,
    tracking_code_hash BYTEA NOT NULL UNIQUE,
